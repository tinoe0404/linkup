...
import { getNotifications, markNotificationsAsRead } from "../actions/notifications.action"; // Adjusted path
import NotificationsSkeleton from "@/components/NotificationSkeleton"; // Changed to default import
